    ...
    className='w-full h-12 flex px-5 py-2 justify-between items-center   text-white absolute top-0'>
       ...
       href="https://x.com/sachinpalsp1402"><FaTwitter/> </motion.a>
        <motion.a 
           initial={{y:-20,opacity:0}}
           whileInView={{y:0,opacity:1}}
           transition={{duration:0.8,delay:0.6}} href="https://www.linkedin.com/in/sachinpal14-02-"><FaLinkedin/> </motion.a>
        <motion.a
           initial={{y:-20,opacity:0}}
           whileInView={{y:0,opacity:1}}
           transition={{duration:0.8,delay:0.8}} href="https://github.com/settings/profile"><FaGithub/></motion.a>
       </div>
    </div>
  )
}
